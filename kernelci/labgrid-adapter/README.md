...
A generic adapter connecting [labgrid](https://labgrid.readthedocs.io/) test
...
```bash
pip install labgrid-kci-adapter
# or
docker pull ghcr.io/openwrt/labgrid-kci-adapter
```
...
services:
  labgrid-adapter:
    image: ghcr.io/openwrt/labgrid-kci-adapter
    environment:
      LAB_NAME: my-lab
...
python -m labgrid_kci_adapter.service
```
