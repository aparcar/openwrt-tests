...
from labgrid_runner.executor import ResultCollectorPlugin, TestExecutor
from labgrid_runner.models import TestStatus
...
class TestTestExecutor:
    ...
    async def test_initialize(self, executor):
        ...
        with patch("labgrid_runner.executor.settings") as mock_settings:
    ...
    async def test_execute_job_success(self, executor, temp_dirs):
        ...
        with patch("labgrid_runner.executor.settings") as mock_settings:
            ...
            with patch(
                "labgrid_runner.executor.ensure_tests",
